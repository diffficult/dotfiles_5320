...
DISPLAY_TEXT="<span font_desc='JetBrainsMono Nerd Font 12' color='${TEMP_COLOR}'>${ICON}</span> <span font_desc='SF Compact Rounded Bold 12' color='${TEMP_COLOR}'>${CPU_TEMP}°C</span>"
